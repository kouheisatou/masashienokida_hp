  ...
  return (
    <div className="min-h-screen">
      ...
      <section className="relative pt-32 pb-12 px-6">
        <div className="max-w-[900px] mx-auto">
          ...
          <div className="flex items-center gap-4 mb-6 text-sm">
            <span className="px-3 py-1.5 bg-white/10 border border-[#8b4545]/30 text-white rounded">
              {post.category}
            </span>
      ...
      <section className="px-6 mb-12">
        <div className="max-w-[900px] mx-auto">
          <div className="relative aspect-[16/9] rounded overflow-hidden border-2 border-[#8b4545]/30">
            <div className={`absolute inset-0 bg-gradient-to-br ${post.imageGradient}`} />
            <div className="absolute inset-0 flex items-center justify-center">
              <div className="text-white/30 text-8xl">♪</div>
            </div>
            {/* Decorative corners */}
            <div className="absolute top-4 left-4 w-16 h-16 border-t-2 border-l-2 border-[#8b4545]/40" />
            <div className="absolute bottom-4 right-4 w-16 h-16 border-b-2 border-r-2 border-[#8b4545]/40" />
          </div>
        </div>
      </section>
        ...
        <div className="max-w-[900px] mx-auto">
          <article className="velvet-card p-8 md:p-12">
            <div
              className="prose prose-invert prose-lg max-w-none
                ...
                prose-h2:text-2xl prose-h2:mt-12 prose-h2:mb-6 prose-h2:pb-3 prose-h2:border-b prose-h2:border-[#8b4545]/20
                prose-p:text-[#f0f0f0]/80 prose-p:leading-relaxed prose-p:mb-6
                prose-strong:text-white prose-strong:font-bold
                prose-ul:text-[#f0f0f0]/80 prose-li:my-2
                prose-a:text-white prose-a:no-underline hover:prose-a:text-[#d4c4b0] prose-a:transition-colors"
          ...
          <div className="mt-8 flex items-center gap-4">
            ...
            <div className="flex gap-3">
              <button className="w-10 h-10 rounded border border-[#8b4545]/30 flex items-center justify-center text-white hover:bg-white/10 hover:border-[#8b4545] transition-all duration-300">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            {relatedPosts.map((relatedPost) => (
              <Link key={relatedPost.id} href={`/blog/${relatedPost.id}`}>
                <div className="velvet-card p-6 cursor-pointer group transition-all duration-300 hover:border-[#8b4545]/40">
                  <div className="mb-3">
                    <span className="text-xs px-2.5 py-1 bg-white/10 border border-[#8b4545]/30 text-white rounded">
                      {relatedPost.category}
                    </span>
                  </div>
                  <h3 className="text-lg font-bold text-white mb-2 group-hover:text-[#d4c4b0] transition-colors line-clamp-2">
                    {relatedPost.title}
                  </h3>
