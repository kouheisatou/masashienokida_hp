...
export default function EditMemberContentPage() {
  const params = useParams();
  const id = params?.id;
  const [isLoading, setIsLoading] = useState(false);
  const [contentType, setContentType] = useState("video"); // Mock initial state
  ...
  return (
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        <h1 className="text-2xl font-bold text-gray-900">Edit Member Content #{id}</h1>
        <Link
          ...
          <div className="grid grid-cols-1 gap-6 md:grid-cols-2">
            <div className="space-y-1">
              ...
              <input
                ...
                id="title"
                name="title"
                defaultValue="Special Video: Practice Session"
