...
export default function DiscographyEditPage() {
  ...
  if (loading) return (
    <AuthGuard><AdminShell>
      <div className="p-4 sm:p-6 lg:p-8"><p className="text-gray-500 text-sm">読み込み中...</p></div>
    ...
    <AuthGuard>
      <AdminShell>
        <div className="p-4 sm:p-6 lg:p-8 max-w-2xl">
          <h1 className="text-xl sm:text-2xl font-bold text-gray-900 mb-6">ディスコグラフィー 編集</h1>
